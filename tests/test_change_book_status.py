...
from tests.fixtures.fixtures import test_book, test_book_2, test_book_3, test_storage_path, test_change_status_prompt
...
class TestChangeBookStatus(unittest.TestCase):
    ...
    def test_change_book_status_prints_correct_message(self):
        ...
        self.assertEqual(
            ...
            f"Book: {test_book.title}, {test_book.year} by {test_book.author}. Status changed to {test_book.status}\n"
        )
